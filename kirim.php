...
try {
    ...
    $mail->Username   = 'rhmdevian1@gmail.com';                     //SMTP username
    $mail->Password   = 'hihn rknn ggwl eqhk';                               //SMTP password
    $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS

    //Recipients
    $mail->setFrom('rhmdevian1@gmail.com', 'Saran GFood');
    $mail->addAddress('rhmdevian1@gmail.com', 'GFood');     //Add a recipient
